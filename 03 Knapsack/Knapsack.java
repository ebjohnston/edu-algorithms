...
public class Knapsack {
    ...
    private void verifyContents() {
        try {
            ...
            capacity = Integer.parseInt(buffer);
    ...
    private void processNode(Node current) {
        ...
        if (current.bound < achievable) {
            System.out.println("    pruned -- achievable profit " + achievable +
            ...
            System.out.println("    note achievable profit of " + current.profit);
